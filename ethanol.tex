...
\newcommand{\mylabelcont}[8]{
	...
	\draw[sep] ({-\lw / 2 - 2mm},{\row{3}+2.5mm}) -- ({\lw / 2 + 2mm},{\row{3}+2.5mm});
	\node[colId]		at ( 0, {\row{4} + 5mm}) {\fontsize{10pt}{1em}\selectfont\musnum{}  #3};
	\node[gender]		at ({\col{3}{4}}, {\row{4} + 5mm}) {\fontsize{10pt}{1em}\selectfont\gender{#5}};
